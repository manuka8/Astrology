            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h1 className="text-4xl md:text-6xl font-bold font-outfit mb-8 text-mystic">
                            Guiding Souls Through the <span className="gold-text-gradient">Cosmos</span>
                        </h1>
                        <p className="text-mystic/70 text-lg leading-relaxed mb-6">
                        ...
                        <p className="text-mystic/70 text-lg leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Card className="flex flex-col gap-4 p-8 border-gold/10 bg-white">
                            <div className="w-12 h-12 bg-gold/10 rounded-xl flex items-center justify-center">
                                <Target className="text-gold" />
                            </div>
                            <h3 className="text-xl font-bold text-gold">Our Mission</h3>
                            <p className="text-mystic/50 text-sm leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {values.map((v, idx) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                            >
                                <Card className="text-center h-full border-gold/5 bg-white shadow-sm">
                                    <div className="w-14 h-14 bg-gold/5 rounded-full flex items-center justify-center mx-auto mb-6">
                                        {v.icon}
                                    </div>
                                    <h4 className="text-xl font-bold mb-4 text-mystic">{v.title}</h4>
                                    <p className="text-mystic/50 text-sm leading-relaxed">{v.desc}</p>
                                </Card>
                            </motion.div>
                        ))}
                    </div>
                ...
                {/* Expertise Section */}
                <div className="py-20 bg-mystic-light border border-gold/10 rounded-[40px] px-12 md:px-20 text-center relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-gold/10 blur-[100px] rounded-full"></div>
                    <div className="relative z-10">
                        <h2 className="text-3xl md:text-5xl font-bold font-outfit mb-8 max-w-2xl mx-auto text-mystic">Ancient Wisdom Meets <span className="gold-text-gradient">Modern Precision</span></h2>
                        <p className="text-mystic/70 text-lg mb-12 max-w-3xl mx-auto">
                        ...
                        <div className="flex justify-center gap-12">
                            <div className="text-center">
                                ...
                                <p className="text-mystic/40 text-xs uppercase">Years Experience</p>
                            </div>
                            <div className="text-center">
                                <p className="text-gold text-2xl font-bold">100%</p>
                                <p className="text-mystic/40 text-xs uppercase">Privacy Secure</p>
                            </div>
                            <div className="text-center">
                                <p className="text-gold text-2xl font-bold">24/7</p>
                                <p className="text-mystic/40 text-xs uppercase">Expert Support</p>
                            </div>
                        </div>
                    </div>
                </div>
